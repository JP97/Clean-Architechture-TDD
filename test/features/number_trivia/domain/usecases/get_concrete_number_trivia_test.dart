...
import 'package:own_clean_architecture/features/domain/usecases/get_concrete_number_trivia.dart';
...
void main() {
  ...
  test('should get trivia for the number frm the repository', () async {
    // arrange
